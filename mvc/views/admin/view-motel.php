<?php ob_start(); if($_SESSION["ROLE"]!=1){
                            ...
                            <div class="table-responsive">
                                <table id="dataTableMotel" class="table table-striped table-bordered" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php
                                            include("Connect.php"); 
                                            $query = "SELECT * FROM motel m INNER JOIN motel_category c ON c.category_id = m.Category_id WHERE status=1";     
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align:center;">
                                                <a href="http://localhost:8888/MNM/Trangcanhan/motel/DEL/<?php echo $row['Motel_Id']; ?>" class="btn btn-info"><i class="far fa-trash-alt"></i></a>
                                            </td>
                                        </tr>
                                        <?php
                                        }
