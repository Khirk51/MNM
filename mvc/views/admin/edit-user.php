        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-body">
                ...
                <div class="input-group mb-3">
                    ...
                    <img src="http://localhost:8888/MNM/public/image/user/<?php echo $row['Avatar']; ?>" style="height: 200px; width: 300px;">
...
<?php
    ...
    if(isset($data["iddel"])){        
        ...
        if($query_run){
            ...
            header('location: http://localhost:8888/MNM/Trangcanhan/user');
        }else{
    ...
    {   
        ...
        if(file_exists("http://localhost:8888/MNM/public/image/user/".$img_name)) {
            ...
            if($query_run){
                move_uploaded_file($_FILES['Avatar']['tmp_name'], 'public/image/user/'.$img_name);
